...
import vn.tapbi.arteditor.di.AppModule;
import vn.tapbi.arteditor.di.AppModule_ProvideRoomDbPhotoFactory;
import vn.tapbi.arteditor.di.AppModule_ProvideSharedFactory;
import vn.tapbi.arteditor.di.AppModule_ProvideSharedPreferenceFactory;
import vn.tapbi.arteditor.di.NetworkModule;
import vn.tapbi.arteditor.di.NetworkModule_ProvidesRetrofitFactory;
import vn.tapbi.arteditor.di.NetworkModule_ProvidesUnsplashApiFactory;
import vn.tapbi.arteditor.feature.VisualizerView;
import vn.tapbi.arteditor.ui.base.BaseActivity;
import vn.tapbi.arteditor.ui.base.BaseActivity_MembersInjector;
import vn.tapbi.arteditor.ui.base.BaseDialogFragment;
...
import vn.tapbi.arteditor.ui.main.home.HomeViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerApp_HiltComponents_SingletonC {
  ...
  private static final class ViewCImpl extends App_HiltComponents.ViewC {
    ...
    @Override
    public void injectVisualizerView(VisualizerView visualizerView) {
    }
  }
  ...
  private static final class ActivityCImpl extends App_HiltComponents.ActivityC {
    ...
    private BaseActivity injectBaseActivity2(BaseActivity instance) {
      BaseActivity_MembersInjector.injectMPrefHelper(instance, singletonCImpl.provideSharedPreferenceProvider.get());
      return instance;
    }
  }
  ...
  private static final class ViewModelCImpl extends App_HiltComponents.ViewModelC {
    ...
    private UnSplashPhotoRepository unSplashPhotoRepository() {
      return new UnSplashPhotoRepository(singletonCImpl.providesUnsplashApiProvider.get(), singletonCImpl.provideRoomDbPhotoProvider.get());
    }
  ...
  private static final class SingletonCImpl extends App_HiltComponents.SingletonC {
    ...
    private Provider<OkHttpClient> providesOkHttpClientAppVersionProvider;

    private Provider<Retrofit> providesRetrofitProvider;

    private Provider<UnsplashApi> providesUnsplashApiProvider;

    private Provider<TapbiDb> provideRoomDbPhotoProvider;
    ...
    private void initialize(final AppModule appModuleParam,
      ...
      this.provideSharedProvider = DoubleCheck.provider(new SwitchingProvider<SharedPreferences>(singletonCImpl, 1));
      this.provideSharedPreferenceProvider = DoubleCheck.provider(new SwitchingProvider<SharedPreferenceHelper>(singletonCImpl, 0));
      this.providesOkHttpClientAppVersionProvider = DoubleCheck.provider(new SwitchingProvider<OkHttpClient>(singletonCImpl, 4));
      this.providesRetrofitProvider = DoubleCheck.provider(new SwitchingProvider<Retrofit>(singletonCImpl, 3));
      this.providesUnsplashApiProvider = DoubleCheck.provider(new SwitchingProvider<UnsplashApi>(singletonCImpl, 2));
      this.provideRoomDbPhotoProvider = DoubleCheck.provider(new SwitchingProvider<TapbiDb>(singletonCImpl, 5));
    }
    ...
    private App injectApp2(App instance) {
      App_MembersInjector.injectMPrefHelper(instance, provideSharedPreferenceProvider.get());
      return instance;
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // vn.tapbi.arteditor.data.local.SharedPreferenceHelper 
          return (T) AppModule_ProvideSharedPreferenceFactory.provideSharedPreference(singletonCImpl.appModule, singletonCImpl.provideSharedProvider.get());

          case 1: // android.content.SharedPreferences 
          return (T) AppModule_ProvideSharedFactory.provideShared(singletonCImpl.appModule, ApplicationContextModule_ProvideApplicationFactory.provideApplication(singletonCImpl.applicationContextModule));

          case 2: // vn.tapbi.arteditor.data.remote.UnsplashApi 
          return (T) NetworkModule_ProvidesUnsplashApiFactory.providesUnsplashApi(singletonCImpl.providesRetrofitProvider.get());

          case 3: // retrofit2.Retrofit 
          return (T) NetworkModule_ProvidesRetrofitFactory.providesRetrofit(singletonCImpl.providesOkHttpClientAppVersionProvider.get());

          case 4: // okhttp3.OkHttpClient 
          return (T) NetworkModule.INSTANCE.providesOkHttpClientAppVersion();

          case 5: // vn.tapbi.arteditor.data.local.db.TapbiDb 
          return (T) AppModule_ProvideRoomDbPhotoFactory.provideRoomDbPhoto(singletonCImpl.appModule, ApplicationContextModule_ProvideApplicationFactory.provideApplication(singletonCImpl.applicationContextModule));
